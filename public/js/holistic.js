$(document).ready(function(){
  ...
  $('.bottom-section').css('margin-top', '324px');

  //slideshow image append
  var img_number = 11;
  for(var x=0;x<img_number;x++){
    $('.project_img').append(
      '<img id="project_small_' + x + '" src="../img/project/holistic/' + x +'_small.jpg"/>'
    );

    $('.project_slide_img').append(
      '<img id="project_big_' + x + '" src="../img/project/holistic/' + x +'_big.jpg"/>'
    );
  };
